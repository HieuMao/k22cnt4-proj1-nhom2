...
.product img{width:100%;height:200px;object-fit:cover;border-bottom:1px solid #eee;border-radius:10px;}
.product h3{font-size:1.2rem;margin:12px 0 5px;}
.product p.price{color:#b8860b;font-weight:600;margin-bottom:6px;}
.product p.category{font-size:.9rem;color:#777;margin-bottom:10px;}
.product button{padding:8px 18px;background:#b8860b;border:none;border-radius:25px;color:#fff;font-weight:600;cursor:pointer;}
.product button:hover{background:#a9740b;}
</style>
</head>
<body>
...
document.querySelectorAll('.add-cart-btn').forEach(btn=>{
    btn.addEventListener('click',async()=>{
        ...
        const res=await fetch('user/add_to_cart.php',{method:'POST',body:new FormData(form)});
